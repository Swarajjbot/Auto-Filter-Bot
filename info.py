...
# Bot information
API_ID = environ.get('API_ID', '26558850')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '410f922c49c8867b5c8e28d624581b02') #api hash of your telegram id
if len(API_HASH) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1967990132') #apni tg id daalo
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001975644381') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002132188358') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://test08:test08@cluster0.jit72we.mongodb.net/?retryWrites=true&w=majority") #mongo db url
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002021932901") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://desirable-josi-indorecinemasop.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
